...
function growThreadCountAndReturnNextAvailable() {
  ...
  (function () {
    if (!(newSize <= 0x10000)) {
      {
        throw ReactError('Maximum number of concurrent React renderers exceeded. This can happen if you are not properly destroying the Readable provided by React. Ensure that you call .destroy() on it if you no longer want to read from it, and did not read to the end. If you use .pipe() this should be automatic.');
      }
    }
  })();
  ...
  if (disableJavaScriptURLs) {
    (function () {
      if (!!isJavaScriptProtocol.test(url)) {
        throw ReactError('React has blocked a javascript: URL as a security precaution.' + (ReactDebugCurrentFrame$2.getStackAddendum()));
      }
    })();
...
function assertValidProps(tag, props) {
  ...
  if (voidElementTags[tag]) {
    (function () {
      if (!(props.children == null && props.dangerouslySetInnerHTML == null)) {
        {
          throw ReactError(tag + ' is a void element tag and must neither have `children` nor use `dangerouslySetInnerHTML`.' + (ReactDebugCurrentFrame$4.getStackAddendum()));
        }
      }
    })();
  }
  ...
  (function () {
    if (!(props.style == null || typeof props.style === 'object')) {
      {
        throw ReactError('The `style` prop expects a mapping from style properties to values, not a string. For example, style={{marginRight: spacing + \'em\'}} when using JSX.' + (ReactDebugCurrentFrame$4.getStackAddendum()));
      }
    }
  })();
}
...
function validateRenderResult(child, type) {
  if (child === undefined) {
    (function () {
      {
        {
          throw ReactError((getComponentName(type) || 'Component') + '(...): Nothing was returned from render. This usually means a return statement is missing. Or, to render nothing, return null.');
        }
      }
    })();
  }
        ...
        for (var contextKey in childContext) {
          (function () {
            if (!(contextKey in childContextTypes)) {
              {
                throw ReactError((getComponentName(Component) || 'Unknown') + '.getChildContext(): key "' + contextKey + '" is not defined in childContextTypes.');
              }
            }
          })();
        }
          ...
          if (frame.type === 'select') {
            ...
            if (suspended) {
              ...
              (function () {
                if (!_fallbackFrame) {
                  {
                    throw ReactError('suspense fallback not found, something is broken');
                  }
                }
              })();
  ...
  ReactDOMServerRenderer.prototype.render = function render(child, context, parentNamespace) {
    if (typeof child === 'string' || typeof child === 'number') {
        ...
        if (nextChild != null && nextChild.$$typeof != null) {
          ...
          (function () {
            if (!($$typeof !== REACT_PORTAL_TYPE)) {
              {
                throw ReactError('Portals are not currently supported by the server renderer. Render them conditionally so that they only appear on the client render.');
              }
            }
          })();
          ...
          (function () {
            {
              {
                throw ReactError('Unknown element-like object type: ' + $$typeof.toString() + '. This is likely a bug in React. Please file an issue.');
              }
            }
          })();
        }
        ...
        case REACT_SUSPENSE_TYPE:
          {
            if (enableSuspenseServerRenderer) {
              ...
              (function () {
                {
                  {
                    throw ReactError('ReactDOMServer does not yet support Suspense.');
                  }
                }
              })();
            }
      ...
      if (typeof elementType === 'object' && elementType !== null) {
        switch (elementType.$$typeof) {
          ...
          case REACT_EVENT_TARGET_TYPE:
            {
              if (enableEventAPI) {
                if (elementType.$$typeof === REACT_EVENT_TARGET_TYPE && elementType.type === REACT_EVENT_TARGET_TOUCH_HIT) {
                  ...
                  return '<div style="position:absolute;z-index:-1;bottom:' + (bottomString + ';left:' + leftString + ';right:' + rightString + ';top:' + topString + '"></div>');
                }
              ...
              (function () {
                {
                  throw ReactError('ReactDOMServer does not yet support the event API.');
                }
              })();
            }
          // eslint-disable-next-line-no-fallthrough
          case REACT_LAZY_TYPE:
            (function () {
              {
                {
                  throw ReactError('ReactDOMServer does not yet support lazy-loaded components.');
                }
              }
            })();
        }
      ...
      (function () {
        {
          {
            throw ReactError('Element type is invalid: expected a string (for built-in components) or a class/function (for composite components) but got: ' + (elementType == null ? elementType : typeof elementType) + '.' + info);
          }
        }
      })();
    }
...
function renderToNodeStream() {
  (function () {
    {
      {
        throw ReactError('ReactDOMServer.renderToNodeStream(): The streaming API is not available in the browser. Use ReactDOMServer.renderToString() instead.');
      }
    }
  })();
}
...
function renderToStaticNodeStream() {
  (function () {
    {
      {
        throw ReactError('ReactDOMServer.renderToStaticNodeStream(): The streaming API is not available in the browser. Use ReactDOMServer.renderToStaticMarkup() instead.');
      }
    }
  })();
}
