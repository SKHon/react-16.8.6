...
function createTextInstance(text, rootContainerInstance, hostContext, internalInstanceHandle) {
  if (true && enableEventAPI) {
    ...
    !(hostContext !== EVENT_TARGET_CONTEXT) ? warning$1(false, 'validateDOMNesting: React event targets cannot have text DOM nodes as children. ' + 'Wrap the child text "%s" in an element.', text) : void 0;
  }
  return {
    text: text,
    isHidden: false,
...
// Intentionally not named imports because Rollup would use dynamic dispatch for
// CommonJS interop named imports.
var now$2 = Scheduler$1.unstable_now;
...
var shouldYield$1 = Scheduler$1.unstable_shouldYield;
var now$1 = Scheduler$1.unstable_now;
var getCurrentPriorityLevel$1 = Scheduler$1.unstable_getCurrentPriorityLevel;
...
function computeMsUntilTimeout(root, absoluteTimeoutMs) {
  ...
  // timestamp to a relative time. This is the value that is passed
  // to `setTimeout`.
  var msUntilTimeout = absoluteTimeoutMs - now();
...
var ReactShouldWarnActingUpdates$2 = ReactSharedInternals.ReactShouldWarnActingUpdates;
...
function act(callback) {
  var previousActingUpdatesScopeDepth = void 0;
  {
    ...
    ReactShouldWarnActingUpdates$2.current = true;
  }
  ...
  function onDone() {
    {
      ...
      if (actingUpdatesScopeDepth === 0) {
        ReactShouldWarnActingUpdates$2.current = false;
      }
  ...
  switch (node.tag) {
    ...
    default:
      (function () {
        {
          {
            throw ReactError('toTree() does not yet know how to handle nodes with tag=' + node.tag);
          }
        }
      })();
  }
...
var ReactTestInstance = function () {
  ReactTestInstance.prototype._currentFiber = function _currentFiber() {
    ...
    (function () {
      if (!(fiber !== null)) {
        {
          throw ReactError('Can\'t read from currently-mounting component. This error is likely caused by a bug in React. Please file an issue.');
        }
      }
    })();
    return fiber;
  ...
  function ReactTestInstance(fiber) {
    ...
    (function () {
      if (!validWrapperTypes.has(fiber.tag)) {
        {
          throw ReactError('Unexpected object passed to ReactTestInstance constructor (tag: ' + fiber.tag + '). This is probably a bug in React.');
        }
      }
    })();
    this._fiber = fiber;
...
var ReactTestRendererFiber = {
  ...
  create: function (element, options) {
    ...
    (function () {
      if (!(root != null)) {
        {
          throw ReactError('something went wrong');
        }
      }
    })();
