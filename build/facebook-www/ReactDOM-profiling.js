    ...
    do {
      ...
      if (18 === value.tag) {
        ...
        sourceFiber.has(thenable) ||
          ...
          (sourceFiber = resolveRetryThenable$$1.bind(null, value, thenable)),
          ...
          0 === (thenable.effectTag & 64) &&
            ("function" === typeof root.getDerivedStateFromError ||
              (null !== earliestTimeoutMs &&
                ...
                !isAlreadyFailedLegacyErrorBoundary$$1(earliestTimeoutMs))))
        ) {
          thenable.effectTag |= 2048;
          thenable.expirationTime = renderExpirationTime;
...
function commitRoot(root, finishedWork) {
  ...
  if (0 === committedExpirationTime) throw ReactErrorProd(261);
    ...
    if (0 === (workInProgress.effectTag & 1024)) {
      ...
      a: {
        ...
        switch (current$$1.tag) {
          ...
          case 5:
            ...
            if (null !== domElement && null != current$$1.stateNode)
              ...
              if (popHydrationState(current$$1)) {
                ...
                i = null;
                for (fiber in props)
                  if (props.hasOwnProperty(fiber)) {
                    var nextProp = props[fiber];
                    "children" === fiber
                      ? "string" === typeof nextProp
                        ...
                        : "number" === typeof nextProp &&
                          renderExpirationTime.textContent !== "" + nextProp &&
                          (i = ["children", "" + nextProp])
                      : registrationNameModules.hasOwnProperty(fiber) &&
                        null != nextProp &&
                        ensureListeningTo(rootContainerInstance, fiber);
                  }
                switch (domElement) {
                  case "input":
                ...
                fiber = i;
                current$$1.updateQueue = fiber;
                (fiber = null !== fiber ? !0 : !1) && markUpdate(current$$1);
              } else {
                domElement =
                ...
                switch (renderExpirationTime) {
                  ...
                  case "details":
                    ...
                    break;
                  case "input":
                    initWrapperState(domElement, fiber);
                    props = getHostProps(domElement, fiber);
                    trapBubbledEvent("invalid", domElement);
                    ensureListeningTo(rootContainerInstance, "onChange");
                    break;
                  case "option":
                    props = getHostProps$1(domElement, fiber);
                    break;
                  case "select":
                    domElement._wrapperState = {
                      wasMultiple: !!fiber.multiple
                    };
                    props = Object.assign({}, fiber, { value: void 0 });
                    trapBubbledEvent("invalid", domElement);
                    ensureListeningTo(rootContainerInstance, "onChange");
                    break;
                  case "textarea":
                    initWrapperState$2(domElement, fiber);
                    props = getHostProps$3(domElement, fiber);
                    trapBubbledEvent("invalid", domElement);
                    ensureListeningTo(rootContainerInstance, "onChange");
                    break;
                  default:
                ...
                switch (renderExpirationTime) {
                  case "input":
                    track(domElement);
                    postMountWrapper(domElement, fiber, !1);
                    break;
                  case "textarea":
                    track(domElement);
                    postMountWrapper$3(domElement, fiber);
                    break;
                  case "option":
                    null != fiber.value &&
                      domElement.setAttribute(
                        "value",
                        "" + getToStringValue(fiber.value)
                      );
                    break;
                  case "select":
                ...
                (fiber = shouldAutoFocusHostComponent(
                  renderExpirationTime,
                  fiber
            ...
            if (domElement && null != current$$1.stateNode)
              ...
              popHydrationState(current$$1)
                ? ((fiber = current$$1.stateNode),
                  ...
                  (fiber[internalInstanceKey] = current$$1),
                  fiber.nodeValue !== renderExpirationTime &&
                    markUpdate(current$$1))
                : ((fiber = (9 === renderExpirationTime.nodeType
                    ? renderExpirationTime
                ...
                for (fiber = 0; current$$1; ) {
                  if (8 === current$$1.nodeType)
                    if (
                      ...
                      fiber--;
                    } else "$" === renderExpirationTime && fiber++;
                  current$$1 = current$$1.nextSibling;
                }
                nextHydratableInstance = null;
              }
          ...
          case 19:
            ...
            current$$1.stateNode.props = fiber;
      ...
      if (
        ...
        if (current$$1.mode & 4) {
          ...
          rootContainerInstance = current$$1.selfBaseDuration;
          domElement =
            null === current$$1.alternate ||
            current$$1.child !== current$$1.alternate.child;
          for (props = current$$1.child; null !== props; )
            (i = props.expirationTime),
              (nextProp = props.childExpirationTime),
              i > fiber && (fiber = i),
              nextProp > fiber && (fiber = nextProp),
              domElement && (renderExpirationTime += props.actualDuration),
              (rootContainerInstance += props.treeBaseDuration),
              (props = props.sibling);
          current$$1.actualDuration = renderExpirationTime;
          current$$1.treeBaseDuration = rootContainerInstance;
        } else
          for (
            ...
            (rootContainerInstance = renderExpirationTime.expirationTime),
              ...
              rootContainerInstance > fiber && (fiber = rootContainerInstance),
              domElement > fiber && (fiber = domElement),
...
function performUnitOfWork(workInProgress) {
  ...
  workInProgress.mode & 4 &&
    ...
    0 > workInProgress.actualStartTime &&
      (workInProgress.actualStartTime = now$3()));
  ...
  if (disableYielding)
    ...
    for (
      recomputeCurrentRendererTime(),
        currentSchedulerTime = currentRendererTime,
        enableUserTimingAPI &&
          ((didTimeout = nextFlushedExpirationTime > currentRendererTime),
          ...
          enableUserTimingAPI &&
            ...
            endMark(
              ...
              didTimeout ? "React was blocked by main thread" : null
            )));
