    ...
    if (0 === (workInProgress.effectTag & 1024)) {
      ...
      workInProgress.effectTag & 64
        ? ((textNode = workInProgress),
          enableUserTimingAPI &&
            supportsUserTiming &&
            !shouldIgnoreFiber(textNode) &&
            ((currentFiber$1 = textNode.return),
            textNode._debugIsCurrentlyTiming &&
              ((textNode._debugIsCurrentlyTiming = !1),
              endFiberMark(
                textNode,
                null,
                13 === textNode.tag || 18 === textNode.tag
...
function completeRoot(root, finishedWork, expirationTime) {
          ...
          switch (anchorOffset.tag) {
            ...
            case 1:
              if (anchorOffset.effectTag & 256 && null !== current$$1) {
                ...
                startPhaseTimer(anchorOffset, "getSnapshotBeforeUpdate");
                var instance = anchorOffset.stateNode,
  ...
  enableUserTimingAPI &&
    supportsUserTiming &&
    ((current$$1 = effectCountInCurrentCommit),
    (effectCountInCurrentCommit = 0),
    endMark(
      "(Committing Snapshot Effects: " + current$$1 + " Total)",
  ...
  enableUserTimingAPI &&
    supportsUserTiming &&
    ((effectTag = effectCountInCurrentCommit),
    (effectCountInCurrentCommit = 0),
    endMark(
      "(Committing Host Effects: " + effectTag + " Total)",
            ...
            case 1:
              ...
              if (current$$1.effectTag & 4) {
                if (null === current$$1$jscomp$1)
                  startPhaseTimer(current$$1, "componentDidMount"),
                  ...
                  startPhaseTimer(current$$1, "componentDidUpdate");
  ...
  enableUserTimingAPI &&
    supportsUserTiming &&
    ((effectTag$jscomp$0 = effectCountInCurrentCommit),
    (effectCountInCurrentCommit = 0),
    endMark(
      "(Calling Lifecycle Methods: " + effectTag$jscomp$0 + " Total)",
