...
function executeDirectDispatch(event) {
  ...
  if (Array.isArray(dispatchListener)) throw ReactErrorProd(103);
...
function getTouchIdentifier(_ref) {
  ...
  if (null == _ref) throw ReactErrorProd(138);
  return _ref;
}
...
function accumulate(current, next) {
  if (null == next) throw ReactErrorProd(29);
  return null == current
    ? next
...
var eventTypes = {
  ...
  getInstanceFromNodeImpl$jscomp$inline_61 = _ReactDOM$__SECRET_IN[0],
  getNodeFromInstanceImpl$jscomp$inline_62 = _ReactDOM$__SECRET_IN[1];
getFiberCurrentPropsFromNode$1 = _ReactDOM$__SECRET_IN[2];
getInstanceFromNode$1 = getInstanceFromNodeImpl$jscomp$inline_61;
getNodeFromInstance$1 = getNodeFromInstanceImpl$jscomp$inline_62;
module.exports = {
