...
function completeWork(current, workInProgress, renderExpirationTime) {
  ...
  switch (workInProgress.tag) {
    ...
    case 5:
      ...
      if (null !== current && null != workInProgress.stateNode)
        ...
        if (popHydrationState(workInProgress)) {
          ...
          switch (type) {
            ...
            case "audio":
              for (current = 0; current < mediaEventTypes.length; current++)
                trapBubbledEvent(mediaEventTypes[current], newProps);
              break;
            case "source":
          ...
          switch (type) {
            ...
            case "textarea":
              track(newProps);
              postMountWrapper$3(newProps, props);
              break;
            case "select":
            case "option":
              break;
          ...
          null !== renderExpirationTime && markUpdate(workInProgress);
        } else {
          propKey =
          ...
          current === Namespaces.html
            ? "script" === type
              ? ((propKey = propKey.createElement("div")),
                (propKey.innerHTML = "<script>\x3c/script>"),
                (propKey = propKey.removeChild(propKey.firstChild)))
              : "string" === typeof newProps.is
                ? (propKey = propKey.createElement(type, { is: newProps.is }))
                : ((propKey = propKey.createElement(type)),
                  "select" === type &&
                    ((current = propKey),
                    newProps.multiple
                      ? (current.multiple = !0)
                      : newProps.size && (current.size = newProps.size)))
            : (propKey = propKey.createElementNS(current, type));
          ...
          switch (type) {
            ...
            case "audio":
              for (nextProp = 0; nextProp < mediaEventTypes.length; nextProp++)
                trapBubbledEvent(mediaEventTypes[nextProp], propKey);
              nextProp = newProps;
              break;
            case "source":
            ...
            case "input":
              ...
              nextProp = getHostProps(propKey, newProps);
              trapBubbledEvent("invalid", propKey);
              ensureListeningTo(renderExpirationTime, "onChange");
              break;
            case "option":
              nextProp = getHostProps$1(propKey, newProps);
              break;
            case "select":
              propKey._wrapperState = { wasMultiple: !!newProps.multiple };
            ...
            case "textarea":
              ...
              nextProp = getHostProps$3(propKey, newProps);
              trapBubbledEvent("invalid", propKey);
              ensureListeningTo(renderExpirationTime, "onChange");
              break;
            default:
                  ...
                  : "children" === props
                    ...
                    : "suppressContentEditableWarning" !== props &&
                      ...
                      (registrationNameModules.hasOwnProperty(props)
                        ? null != nextProp$jscomp$0 &&
                          ensureListeningTo(renderExpirationTime, props)
                        : null != nextProp$jscomp$0 &&
                          setValueForProperty(
                            propKey,
                            props,
          ...
          switch (type) {
            ...
            case "textarea":
              track(propKey);
              postMountWrapper$3(propKey, newProps);
              break;
            case "option":
              null != newProps.value &&
                propKey.setAttribute(
                  "value",
      ...
      } else if (null === workInProgress.stateNode) throw ReactErrorProd(166);
      break;
    case 6:
      if (current && null != workInProgress.stateNode)
        ...
        popHydrationState(workInProgress)
          ? ((renderExpirationTime = workInProgress.stateNode),
            ...
            renderExpirationTime.nodeValue !== newProps &&
              markUpdate(workInProgress))
          : ((renderExpirationTime = (9 === renderExpirationTime.nodeType
              ? renderExpirationTime
              : renderExpirationTime.ownerDocument
    ...
    case 13:
      ...
      null === current
        ...
        : !renderExpirationTime &&
          ...
          null !== type &&
            ((props = workInProgress.firstEffect),
            null !== props
              ? ((workInProgress.firstEffect = type), (type.nextEffect = props))
    ...
    case 18:
      if (null === current) {
        if (!popHydrationState(workInProgress)) throw ReactErrorProd(318);
        workInProgress = workInProgress.stateNode;
        if (!workInProgress) throw ReactErrorProd(317);
        a: {
          workInProgress = workInProgress.nextSibling;
          for (renderExpirationTime = 0; workInProgress; ) {
            if (8 === workInProgress.nodeType)
              if (((newProps = workInProgress.data), "/$" === newProps)) {
                if (0 === renderExpirationTime) {
                ...
                renderExpirationTime--;
              } else "$" === newProps && renderExpirationTime++;
            workInProgress = workInProgress.nextSibling;
          }
          nextHydratableInstance = null;
        }
    ...
    case 19:
      popHostContext(workInProgress);
      renderExpirationTime = requiredContext(rootInstanceStackCursor.current);
      type = workInProgress.type.responder;
      workInProgress.stateNode.props = newProps;
      workInProgress.stateNode.rootInstance = renderExpirationTime;
...
function renderRoot$1(root$jscomp$0, expirationTime$jscomp$0, isSync) {
  ...
  if (
    ...
    prepareFreshStack(root$jscomp$0, expirationTime$jscomp$0),
      startWorkOnPendingInteraction(root$jscomp$0, expirationTime$jscomp$0);
  if (null !== workInProgress) {
...
function performUnitOfWork$1(unitOfWork) {
  ...
  0 !== (unitOfWork.mode & 4)
    ? ((profilerStartTime = now$3()),
      0 > unitOfWork.actualStartTime && (unitOfWork.actualStartTime = now$3()),
      (current$$1 = beginWork$1(
        current$$1,
        unitOfWork,
  ...
  do {
    ...
    if (0 === (workInProgress.effectTag & 1024)) {
      if (0 === (workInProgress.mode & 4))
        ...
        profilerStartTime = now$3();
        0 > fiber.actualStartTime && (fiber.actualStartTime = now$3());
        current$$1 = completeWork(
          current$$1,
          workInProgress,
          renderExpirationTime$1
...
function commitRootImpl(root, expirationTime) {
  ...
  if (null !== firstEffect) {
    ...
    do
      try {
        for (
          firstEffect = root, effectTag = expirationTime;
          null !== nextEffect$1;
          ...
          if (effectTag$jscomp$0 & 36) {
            ...
            switch (current$$1$jscomp$0.tag) {
              ...
              case 1:
                ...
                if (current$$1$jscomp$0.effectTag & 4) {
                  if (null === current$$1$jscomp$1)
                    ...
                    startPhaseTimer(current$$1$jscomp$0, "componentDidUpdate");
              ...
              case 3:
                ...
                break;
              case 5:
                var _instance2 = current$$1$jscomp$0.stateNode;
              ...
              case 4:
                break;
              case 12:
                var onRender = current$$1$jscomp$0.memoizedProps.onRender;
                onRender(
                  current$$1$jscomp$0.memoizedProps.id,
                  null === current$$1$jscomp$1 ? "mount" : "update",
                  current$$1$jscomp$0.actualDuration,
                  current$$1$jscomp$0.treeBaseDuration,
                  current$$1$jscomp$0.actualStartTime,
                  commitTime,
                  alternate.memoizedInteractions
                );
                break;
              case 13:
              case 17:
          ...
          if (effectTag$jscomp$0 & 128) {
            ...
            if (null !== ref) {
              ...
              switch (nextEffect$1.tag) {
                case 5:
                  current$$1$jscomp$0 = instance$jscomp$1;
                  break;
                default:
                  current$$1$jscomp$0 = instance$jscomp$1;
              }
              "function" === typeof ref
                ? ref(current$$1$jscomp$0)
                : (ref.current = current$$1$jscomp$0);
            }
          }
