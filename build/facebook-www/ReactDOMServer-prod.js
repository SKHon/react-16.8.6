...
function resolveCurrentlyRenderingComponent() {
  if (null === currentlyRenderingComponent) throw ReactErrorProd(321);
  return currentlyRenderingComponent;
}
function createHook() {
  if (0 < numberOfReRenders) throw ReactErrorProd(312);
...
function validateRenderResult(child, type) {
  if (void 0 === child)
    throw ReactErrorProd(152, getComponentName(type) || "Component");
}
  ...
  function processChild(element, Component) {
    ...
    if (
      ...
      for (var contextKey in element)
        if (!(contextKey in publicContext))
...
var ReactDOMServerRenderer = (function() {
    function ReactDOMServerRenderer(children, makeStaticMarkup) {
      ...
      if (0 === JSCompiler_inline_result) {
        ...
        if (!(65536 >= newSize)) throw ReactErrorProd(304);
          ...
          if (suspended || frame.childIndex >= frame.children.length) {
            ...
            if ("select" === frame.type) this.currentSelectValue = null;
              ...
              if (suspended) {
                ...
                if (!_fallbackFrame) throw ReactErrorProd(303);
    ...
    ReactDOMServerRenderer.prototype.render = function(
      ...
      if (!React.isValidElement(child)) {
        if (null != child && null != child.$$typeof) {
          ...
          if (parentNamespace === REACT_PORTAL_TYPE) throw ReactErrorProd(257);
          throw ReactErrorProd(258, parentNamespace.toString());
        }
        child = toArray(child);
        this.stack.push({
          type: null,
        ...
        switch (elementType.$$typeof) {
          ...
          case REACT_EVENT_TARGET_TYPE:
            if (
              ...
              return (
                (elementType = child.props),
                (parentNamespace = elementType.bottom || 0),
                (context = elementType.left || 0),
                (child = elementType.right || 0),
                (elementType = elementType.top || 0),
                0 === parentNamespace &&
                0 === context &&
                0 === child &&
                0 === elementType
                  ...
                  : '<div style="position:absolute;z-index:-1;bottom:' +
                    ((parentNamespace ? "-" + parentNamespace + "px" : "0px") +
                      ";left:" +
                      (context ? "-" + context + "px" : "0px") +
                      ";right:" +
                      (child ? "-" + child + "px" : "0x") +
                      ";top:" +
                      (elementType ? "-" + elementType + "px" : "0px") +
                      '"></div>')
              );
            child = toArray(child.props.children);
            this.stack.push({
    ...
    ReactDOMServerRenderer.prototype.renderDOM = function(
      ...
      if (!validatedTagCache.hasOwnProperty(tag)) {
        if (!VALID_TAG_REGEX.test(tag)) throw ReactErrorProd(65, tag);
        ...
        if (null == initialValue) {
          ...
          if (null != textareaChildren) {
            ...
            if (Array.isArray(textareaChildren)) {
              if (!(1 >= textareaChildren.length)) throw ReactErrorProd(93);
      ...
      if ((initialValue = props)) {
        ...
        if (null != initialValue.dangerouslySetInnerHTML) {
          if (null != initialValue.children) throw ReactErrorProd(60);
          if (
            !(
  ...
  ReactDOMServerBrowser = {
    ...
    renderToNodeStream: function() {
      throw ReactErrorProd(207);
    },
    renderToStaticNodeStream: function() {
      throw ReactErrorProd(208);
    },
    version: "16.8.6"
  },
