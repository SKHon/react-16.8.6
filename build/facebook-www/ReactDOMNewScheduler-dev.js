...
function runResponderEventsInBatch(
  topLevelType,
  targetFiber,
  nativeEvent,
  nativeEventTarget,
  ...
  if (enableEventAPI) {
    currentEventQueue = createEventQueue();
    var responderEvent = createResponderEvent(
      topLevelType,
      nativeEvent,
      nativeEventTarget,
      eventSystemFlags
...
function getChildHostContextForEventTarget(parentHostContext, type) {
  {
    ...
    return {
      ...
      ancestorInfo: _ancestorInfo4,
      eventData: _eventData2
    };
  }
  return parentHostContext;
}
...
var shouldYield$1 = disableYielding
  ? function() {
      return false;
      ...
      if (
        ...
        if (earliestTimeoutMs === -1) {
          ...
          if (startTimeMs === -1) {
            ...
            startTimeMs = inferStartTimeFromExpirationTime$$1(
              root,
              renderExpirationTime
            );
          }
...
var unbatchedUpdates$$1 = enableNewScheduler
  ? unbatchedUpdates$2
  : unbatchedUpdates$1;
var flushSync$$1 = enableNewScheduler ? flushSync$2 : flushSync$1;
var flushControlled$$1 = enableNewScheduler
  ? flushControlled$2
  : flushControlled$1;
...
var computeUniqueAsyncExpiration$$1 = enableNewScheduler
  ? computeUniqueAsyncExpiration$2
  : computeUniqueAsyncExpiration$1;
...
var inferStartTimeFromExpirationTime$$1 = enableNewScheduler
  ? inferStartTimeFromExpirationTime$2
  : inferStartTimeFromExpirationTime$1;
...
var unstableNewScheduler_fb = ReactDOMFB$1.default || ReactDOMFB$1;

module.exports = unstableNewScheduler_fb;
