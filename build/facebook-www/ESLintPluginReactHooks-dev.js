  ...
  create: function(context) {
    ...
    function visitFunctionExpression(node) {
      ...
      function gatherDependenciesRecursively(currentScope) {
        ...
        try {
          for (
            var _iterator = currentScope.references[Symbol.iterator](), _step;
      ...
      if (declaredDependenciesNode.type !== "ArrayExpression") {
        ...
        declaredDependenciesNode.elements.forEach(function(
          ...
          var isDeclaredInComponent = !componentScope.through.some(function(
            ref
          ) {
          ...
          switch (setStateRecommendation.form) {
            ...
            case "updater":
              extraWarning =
                ...
                setStateRecommendation.setter +
                "(" +
                setStateRecommendation.missingDep.substring(0, 1) +
                " => ...)' if you only need '" +
                setStateRecommendation.missingDep +
                "'" +
...
function collectRecommendations(_ref5) {
  ...
  function markAllParentsByPath(rootNode, path, fn) {
    ...
    try {
      for (
        var _iterator4 = keys[Symbol.iterator](), _step4;
...
function fastFindReferenceWithParent(start, target) {
  ...
  while (queue.length) {
    ...
    try {
      for (
        var _iterator5 = Object.entries(item)[Symbol.iterator](), _step5;
