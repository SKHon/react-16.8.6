          ...
          case 13:
            ...
            null !== current &&
              ...
              null !== current &&
                ...
                (current.effectTag = 8)));
            instance && (current$$1.effectTag |= 4);
            break;
          case 7:
            break;
          case 8:
              ...
              do {
                ...
                if (current$$1) {
                  ...
                  current$$1.has(returnFiber$jscomp$0) ||
                    ...
                    (sourceFiber$jscomp$0 = pingSuspendedRoot$$1.bind(
                      null,
                      ...
                      do {
                        ...
                        if (void 0 !== destroy) {
                          ...
                          try {
                            ...
                            captureCommitPhaseError$$1(finishedWork, error);
                          }
                        }
        ...
        if (effectTag$jscomp$0 & 128) {
          ...
          if (null !== ref) {
            ...
            switch (nextEffect.tag) {
              case 5:
                lastEffect = instance$jscomp$2.canonical;
                break;
              default:
                lastEffect = instance$jscomp$2;
            }
            "function" === typeof ref
              ? ref(lastEffect)
              : (ref.current = lastEffect);
          }
        }
